    ...
    <>
      ...
      <main className="container py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold mb-8">Selamat Datang, {session.user?.name}</h1>
            ...
            <div className="bg-white rounded-xl border border-slate-100 p-6 shadow-sm">
              ...
              <div className="text-slate-600 space-y-2">
                <p className="text-sm rounded-md bg-slate-50 p-3">
                  Anda baru saja bergabung dengan TravelMate. Mulai buat checklist untuk perjalanan Anda!
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-slate-100 p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { name: 'Antar Kota', icon: 'city' },
                { name: 'Luar Negeri', icon: 'globe' }
              ].map((template) => (
                <Link 
